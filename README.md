...
#> $ display_text_width      <dbl> 184, 184, 140, 140, 187, 64, 271, 141, 2…
#> $ reply_to_status_id      <chr> NA, NA, NA, NA, NA, NA, NA, "11150062352…
#> $ reply_to_user_id        <chr> NA, NA, NA, NA, NA, NA, NA, "76682760", …
#> $ reply_to_screen_name    <chr> NA, NA, NA, NA, NA, NA, NA, "AERA_EdRese…
#> $ is_quote                <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ is_retweet              <lgl> FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, …
#> $ favorite_count          <int> 0, 4, 0, 0, 2, 242, 11, 4, 2, 3, 9, 3, 5…
#> $ retweet_count           <int> 0, 0, 4, 5, 2, 33, 3, 1, 2, 2, 2, 1, 3, …
...
#> $ retweet_followers_count <int> NA, NA, 288, 3550, NA, NA, NA, NA, NA, N…
...
#> $ followers_count         <int> 30074, 30074, 74, 10, 31743, 31743, 3174…
#> $ friends_count           <int> 2254, 2254, 781, 48, 7661, 7661, 7661, 7…
#> $ listed_count            <int> 679, 679, 1, 0, 679, 679, 679, 679, 679,…
#> $ statuses_count          <int> 14912, 14912, 412, 95, 11863, 11863, 118…
#> $ favourites_count        <int> 5830, 5830, 449, 84, 7508, 7508, 7508, 7…
...
#>    <chr>           <chr>           <chr>    
#>  1 DP_Discourse    Dra_LuzYadira   retweet  
#>  2 MariaLeite73    UF_COE          retweet  
#>  3 AERA_EdResearch brownellcassie  retweet  
#>  4 AERA_EdResearch lizjmeyer       retweet  
#>  5 AERA_EdResearch sapnaik         retweet  
#>  6 AERA_EdResearch lorelleespinosa retweet  
#>  7 AERA_EdResearch blackstockberns retweet  
#>  8 AERA_EdResearch DrChezareWarren retweet  
#>  9 AERA_EdResearch JuliePosselt    retweet  
#> 10 AERA_EdResearch eh_trig         retweet  
#> # … with 69,110 more rows
