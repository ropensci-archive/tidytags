...
At this point, you can view an interactive map in your R environment by simply calling `example_map`. Or, if you want to save a screenshot of the map, you can use the function `mapview::mapshot()`.

```{r show-map}
mapview::mapshot(example_map, file="example-map.png")
knitr::include_graphics("example-map.png")
```
