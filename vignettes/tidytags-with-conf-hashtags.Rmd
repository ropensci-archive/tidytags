...
When this vignette was run on Aug 07 22, the TAGS tracker had collected 18 variables associated with 2564 tweets. The first method searching with `id_str` collected 43 variables associated with 2195 tweets. The second method using 'tidytags::get_char_tweet_ids()' collected 43 variables associated with 2195 tweets.
...
#> Rows: 2,195
#> Columns: 43
#> $ created_at                    <dttm> 2020-04-19 15:22:23, 2020-03-01 15:0…
#> $ id                            <dbl> 1.251954e+18, 1.234207e+18, 1.229405e…
#> $ id_str                        <chr> "1251954312772812801", "1234206946732…
#> $ full_text                     <chr> "RT @RoutledgeEd: Congrats to authors…
#> $ truncated                     <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ display_text_range            <dbl> 140, 140, 140, 140, 268, 140, 140, 14…
#> $ entities                      <list> [[<data.frame[1 x 2]>], [<data.frame…
#> $ source                        <chr> "<a href=\"https://mobile.twitter.com…
#> $ in_reply_to_status_id         <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ in_reply_to_status_id_str     <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ in_reply_to_user_id           <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ in_reply_to_user_id_str       <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ in_reply_to_screen_name       <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ geo                           <list> NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ coordinates                   <list> [<data.frame[1 x 3]>], [<data.frame[…
#> $ place                         <list> [<data.frame[1 x 3]>], [<data.frame[…
#> $ contributors                  <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ is_quote_status               <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ retweet_count                 <int> 4, 28, 2, 2, 2, 9, 9, 9, 9, 9, 1, 9, …
#> $ favorite_count                <int> 0, 0, 0, 0, 8, 0, 0, 0, 0, 0, 4, 0, 0…
#> $ favorited                     <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ retweeted                     <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ possibly_sensitive            <lgl> NA, NA, NA, NA, FALSE, NA, NA, NA, NA…
#> $ lang                          <chr> "en", "en", "en", "en", "en", "en", "…
#> $ retweeted_status              <list> [<data.frame[1 x 30]>], [<data.frame…
#> $ quoted_status_id              <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ quoted_status_id_str          <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ quoted_status_permalink       <list> [<data.frame[1 x 3]>], [<data.frame[…
#> $ quoted_status                 <list> [<data.frame[1 x 26]>], [<data.frame…
#> $ text                          <chr> "RT @RoutledgeEd: Congrats to authors…
#> $ favorited_by                  <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ scopes                        <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ display_text_width            <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ quote_count                   <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ timestamp_ms                  <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ reply_count                   <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ filter_level                  <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ metadata                      <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ query                         <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ withheld_scope                <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ withheld_copyright            <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ withheld_in_countries         <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ possibly_sensitive_appealable <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
```
...
In the dataset of 2195 tweets, there are 62 replies, 1142 retweets, 102 quote tweets, and 457 tweets that are not replies, retweets, or quote tweets.
