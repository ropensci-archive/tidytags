...
3. Click on the API key to edit it. In particular, add a Website restriction, `*sheets.googleapis.com/*`, so that your new Google API key can only be used to access Google Sheets.
