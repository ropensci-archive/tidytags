...
This vignette introduces the initial setup necessary to use {tidytags}. Specifically, attention is given to three areas of setup where trouble make occur:

1. Make sure your TAGS tracker can be accessed
2. Get and store Twitter API keys
