...
You're now ready to proceed to using {tidytags}! Head over to the [Using tidytags with a conference hashtag](https://bretsw.github.io/tidytags/articles/tidytags-with-conf-hashtags.html) vignette to learn more about the functionality of the package.
