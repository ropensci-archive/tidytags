...
test_that("user data is added properly", {
  ...
  expect_true("name_sender" %in% names(el_plus))
  expect_true("location_sender" %in% names(el_plus))
  expect_true("description_sender" %in% names(el_plus))
  expect_true("receiver" %in% names(el_plus))
  expect_true("user_id_receiver" %in% names(el_plus))
  expect_true("name_receiver" %in% names(el_plus))
  expect_true("location_receiver" %in% names(el_plus))
  expect_true("description_receiver" %in% names(el_plus))
