...
example_after_rtweet <- pull_tweet_data(example_snippet)
```
...
The **rTAGS** package is licensed under a GNU General Public License v3.0, or [GPL-3](https://choosealicense.com/licenses/lgpl-3.0/). Read more at http://r-pkgs.had.co.nz/description.html#license.
